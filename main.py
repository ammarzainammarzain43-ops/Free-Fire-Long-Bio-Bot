...
OWNER_USERNAME = '' # add your telegram username here. example: '@frb0c'
REQUIRED_CHANNEL = '' # add your required channel username here. example: '@ammar_longbiobot'. if you dont have any channel then leave it blank.
